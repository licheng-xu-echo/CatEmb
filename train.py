...
from catemb.utils import setup_logger,str_to_bool
...
def main():
    ...
    parser.add_argument("--emb_dest_dim", type=int, default=32, help="embedding destination dimension")
    ...
    parser.add_argument("--loss_metric", type=str, default="EBM_dot_prod", help="loss metric", choices=["InfoNCE_dot_prod","EBM_dot_prod"])
